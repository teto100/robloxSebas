...
print("Iniciando construccion del castillo...")

-- Borrar Baseplate original
local baseplate = workspace:FindFirstChild("Baseplate")
if baseplate then
	baseplate:Destroy()
	print("Baseplate original eliminado")
end
...
torre1.Position = Vector3.new(-50, 19, -50)
...
techo1.Position = Vector3.new(-50, 41.5, -50)
...
torre2.Position = Vector3.new(50, 19, -50)
...
techo2.Position = Vector3.new(50, 41.5, -50)
...
torre3.Position = Vector3.new(-50, 19, 50)
...
torre4.Position = Vector3.new(50, 19, 50)
...
murallaFrente.Position = Vector3.new(0, 11.5, -50)
...
murallaAtras.Position = Vector3.new(0, 11.5, 50)
...
murallaIzq.Position = Vector3.new(-50, 11.5, 0)
...
murallaDer.Position = Vector3.new(50, 11.5, 0)
...
castillo.Position = Vector3.new(0, 24, 0)
...
puerta.Position = Vector3.new(0, 9, -48)
...
antorcha.Position = Vector3.new(-15, 6.5, -45)
...
spawn.Position = Vector3.new(0, 2.5, -35)
spawn.Anchored = true
...
print("CASTILLO CREADO! Mira alrededor con la camara")
